...
public class TeamGrid extends JPanel
{
  ...
  public static Color[] TeamColors = {
    new Color(0xFF,0xB6,0xC1), // Red    : lightPink,   darkRed
  ...
  public static Color[] TeamText = {
    new Color(0x8B,0x00,0x00), // Red    : lightPink,   darkRed
  ...
  /*
   * Colors:
   * "Red", "Orange", "Gold", "Green", "Blue", "Purple", "Brown", "Pink"
   * 
   * CSS Colors:
    $dark = "dark".$color;
    $light = "light".$color;
    if ($light == "lightRed")    $light = "lightPink";
    if ($light == "lightGold")   $light = "lightYellow";
    if ($light == "lightOrange") $light = "Moccasin";
    if ($light == "lightPurple") $light = "Thistle";
    if ($light == "lightBrown")  $light = "Wheat";
    if ($dark  == "darkGold")    $dark  = "Gold";
    if ($dark  == "darkPurple")  $dark  = "Purple";
    if ($dark  == "darkBrown")   $dark  = "SaddleBrown";
    if ($dark  == "darkPink")    $dark  = "DeepPink";
   * 
   */
